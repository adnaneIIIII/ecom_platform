    ...
    <nav className="w-full max-w-8xl mx-auto px-2 lg:px-8  py-5 flex items-center justify-between">
      <div className="flex items-center">
        <Link href="/" className="flex items-center gap-2">
          ...
          <h2 className="font-bold text-gray-800 text-xl hidden lg:block">
            Golden Shop
          </h2>
        </Link>
      </div>
      ...
      <div className="flex items-center">
        {user ? (
          <>
            ...
            >
              <Heart className="w-6 h-6 text-gray-700 group-hover:text-gray-700" />
            </Link>
            <Link
              href={"/ShoppingBag"}
              className="group p-2 flex items-center mr-2"
            >
              <ShoppingBag className="w-6 h-6 text-gray-700 group-hover:text-gray-700" />
          ...
          <div className="flex items-center">
            ...
            <LoginLink>
              <User className="w-6 h-6 text-gray-700 group-hover:text-gray-700" />
            </LoginLink>
          </div>
        )}
      </div>
